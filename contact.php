...
.bg-image-overlay::before {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(0, 0, 0, 0.733); /* Overlay color with opacity */
  z-index: 1;
}
...
<!-- Main content -->
<div class="container-fluid mt-5 mb-4 min-vh-100 position-relative bg-image-overlay" style="background-image: url('images/contact.webp'); background-size: cover; background-position: center;">
    ...
    <div class="row mb-4 mt-4 justify-content-center position-relative" style="z-index: 1;">
      ...
      <div class="col-12 col-md-4 mt-5">
       ...
       <div class="col-12 col-md-3 mt-5">
        <div class="card border-0 rounded-0 justify-content-center bg-white">
          <h6 class="p-4 fw-light">
